<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="sede" class="form-control @error('sede') is-invalid @enderror" value="{{ old('sede', $impresora?->sede) }}" id="sede">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="num_contrato" class="form-control @error('num_contrato') is-invalid @enderror" value="{{ old('num_contrato', $impresora?->num_contrato) }}" id="num_contrato">
